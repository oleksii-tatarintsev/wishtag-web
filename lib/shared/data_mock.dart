  ...
  static List<User> get users => [
    User(
      ...
      wishLists: [
        WishList(
          id: _uuidGenerator(),
          title: 'Really expensive wishlist',
          description: 'Cars and everything for cars',
          ...
          wishes: [
            Wish(
              id: _uuidGenerator(),
              title: 'Volvo 740',
              description: 'Volvo 740 1986 as a retro car.',
              photos: ['https://i.imgur.com/ns9os6K.png', 'https://i.imgur.com/vbqLjT7.png'],
              links: ['https://ru.wikipedia.org/wiki/Volvo_700'],
              geoPoints: [''],
            ),
            Wish(
              id: _uuidGenerator(),
              title: 'VW Golf 7 wagon',
              description: 'As a main car VW Golf',
              photos: ['https://i.imgur.com/wgqLbqo.png', 'https://i.imgur.com/ITKsZWN.png'],
              links: ['https://uk.wikipedia.org/wiki/Volkswagen_Golf_7'],
              geoPoints: [''],
            ),
            Wish(
              id: _uuidGenerator(),
              title: 'Vacuum cleaner for car',
              description: 'Vacuum cleaner for car',
              photos: ['https://i.imgur.com/XcALEoA.png'],
              links: ['https://rozetka.com.ua/ua/inspire-is-12000/p398167290/'],
              geoPoints: [''],
            ),
          ],
        ),
        WishList(
          id: _uuidGenerator(),
          title: 'Home',
          description: 'All what I want at home',
          type: WishListType.private,
          allowedUsers: [],
          wishes: [
            Wish(
              id: _uuidGenerator(),
              title: 'DELONGHI Dedica Arte EC885.GY',
              description: '',
              photos: ['https://i.imgur.com/0qdQgKX.png', 'https://i.imgur.com/fYCDnPH.png'],
              links: ['https://bt.rozetka.com.ua/ua/delonghi-ec885gy/p352483923/'],
              geoPoints: [],
            ),
            Wish(
              id: _uuidGenerator(),
              title: 'Flipchart',
              description: 'It is really cool for organising tasks, work',
              photos: ['https://i.imgur.com/l4nYtp5.png'],
              links: ['https://rozetka.com.ua/ua/buromax_bm_0011/p5411514/'],
              geoPoints: [''],
            ),
          ],
        ),
